...
if __name__ == '__main__':
    ...
    os.system(f"python .\\process_pipline_crate_pics.py --input_dir {args.input_dir} --bin {args.bin} --TPS {args.TPS} --DELTA_T {args.DELTA_T} --output_dir {args.input_dir+"\\_pics"} ")
